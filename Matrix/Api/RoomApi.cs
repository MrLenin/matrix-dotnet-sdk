...
namespace Matrix
{
    ...
    {	
		...
		public virtual string RoomStateSend(string roomId, string type, MatrixRoomStateEvent message, string key = "")
        {
            ...
            var apiPath = new Uri($"/_matrix/client/r0/rooms/{Uri.EscapeDataString(roomId)}/state/{type}/{key}", UriKind.Relative);
		...
		public void RoomTypingSend(string roomId, bool typing, int timeout = 0)
		{
            ...
            var msgData = timeout == 0 ?
                JObject.FromObject (new {typing}) :
                JObject.FromObject(new {typing,timeout});
	    ...
	    [MatrixSpec(EMatrixSpecApiVersion.R001, EMatrixSpecApi.ClientServer, "get-matrix-client-r0-rooms-roomid-state-eventtype")]
	    ...
	    [MatrixSpec(EMatrixSpecApiVersion.R001, EMatrixSpecApi.ClientServer, "get-matrix-client-r0-rooms-roomid-messages")]
	    ...
	    [MatrixSpec(EMatrixSpecApiVersion.R001, EMatrixSpecApi.ClientServer, "get-matrix-client-r0-user-userid-rooms-roomid-tags")]
